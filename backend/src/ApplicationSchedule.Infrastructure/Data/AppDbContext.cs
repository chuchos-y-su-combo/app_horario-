    ...
    private static void ConfigurarAsignaturas(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Asignatura>(entity =>
        {
            ...
            entity.HasData(
                ...
                new Asignatura { IdAsignatura = "a2000026-a200-a200-a200-a20000000000", IdPlan = "22222222-2222-2222-2222-222222222222", Codigo = "103021", Nombre = "Diseño de Algoritmos", Creditos = 3, Semestre = 8, MinEstudiantes = 15, EsAreaProfesional = true, Aula = "AULA-F226" },
                ...
                // Semestre 10
                new Asignatura { IdAsignatura = "a2000031-a200-a200-a200-a20000000000", IdPlan = "22222222-2222-2222-2222-222222222222", Codigo = "103125", Nombre = "Sistemas de Información y Organizaciones", Creditos = 3, Semestre = 10, MinEstudiantes = 15, EsAreaProfesional = true, Aula = "AULA-F231" },
                new Asignatura { IdAsignatura = "a2000032-a200-a200-a200-a20000000000", IdPlan = "22222222-2222-2222-2222-222222222222", Codigo = "103117", Nombre = "Inteligencia Artificial", Creditos = 3, Semestre = 10, MinEstudiantes = 15, EsAreaProfesional = true, Aula = "AULA-F232" },
                // Semestre 12
